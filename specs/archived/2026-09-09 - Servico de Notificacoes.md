...
| Banco de Auth | `SqlUnitOfWork`, repositórios SQL, [migrations](../src/Services/Auth/Ouroboros.Services.Auth.Infrastructure/Migrations) | Adicionar outbox e correlação UUID; migrations independentes por banco. |
...
| Alterar | [AuthModule.cs](../src/Services/Auth/Ouroboros.Services.Auth.Infrastructure/AuthModule.cs), [migrations SQL](../src/Services/Auth/Ouroboros.Services.Auth.Infrastructure/Migrations) | Mapear outbox e UUID. Revisar `SqlUnitOfWork` para retry da transação não gerar novas solicitações involuntárias. |
