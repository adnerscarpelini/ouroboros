...
namespace Ouroboros.Modules.Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260901235003_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ouroboros.Modules.Auth.Domain.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ouroboros.Modules.Auth.Domain.Token", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ouroboros.Modules.Auth.Domain.TokenType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ouroboros.Modules.Auth.Domain.RefreshToken", b =>
                {
                    b.HasOne("Ouroboros.Modules.Auth.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ouroboros.Modules.Auth.Domain.Token", b =>
                {
                    b.HasOne("Ouroboros.Modules.Auth.Domain.TokenType", null)
                        .WithMany()
