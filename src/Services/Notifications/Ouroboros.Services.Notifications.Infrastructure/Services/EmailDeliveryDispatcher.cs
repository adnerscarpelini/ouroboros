...
// e grava o resultado. Separado do EmailDeliveryProcessor de propósito — aqui mora o "o que fazer",
...
public sealed class EmailDeliveryDispatcher
{
	...
	private readonly ILogger<EmailDeliveryDispatcher> _logger;

	public EmailDeliveryDispatcher(
