...
namespace Ouroboros.Services.Notifications.Infrastructure.Tests.Integration;

// Sobe um Postgres efêmero (Testcontainers), aplica as migrations reais do serviço Notifications
// com o mesmo MigrationRunner usado pelo Ouroboros.DatabaseMigrator, e mantém o container vivo
// durante toda a coleção de testes — subir o container é caro, então isso acontece uma única vez.
public sealed class NotificationsDatabaseFixture : IAsyncLifetime
{
	private readonly PostgreSqlContainer _container = new PostgreSqlBuilder("postgres:17")
		.WithDatabase("ouroboros_notifications")
		.WithUsername("notifications_service")
		.WithPassword("notifications_service")
		.Build();
...
public sealed class NotificationsDatabaseCollection : ICollectionFixture<NotificationsDatabaseFixture>
{
	public const string Name = "Notifications database";
}
